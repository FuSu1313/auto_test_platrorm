...
AutoTest 是一个功能强大的智能自动测试平台，集成了 AI 需求分析、测试用例生成、API 自动化测试、UI 自动化测试、测试用例管理、评审、执行和报告等完整功能。

<div align="center">
  <img src=".github/images/111.png" alt="AutoTest 界面截图" width="100%">
  <img src=".github/images/222_v2.png" alt="AutoTest 界面截图" width="100%">
  <img src=".github/images/333.png" alt="AutoTest 界面截图" width="100%">
</div>
...
# 创建数据库
mysql -u root -p
CREATE DATABASE AutoTest CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
EXIT;
